...
public class SignController {
    ...
    public ResponseEntity<SignUpResultDto> refreshToken(HttpServletRequest req, @RequestParam String refreshToken) {
        ...
        String accessToken = headerAuth == null ? null : headerAuth.substring("Bearer".length()).trim();

        log.info("[refresh-token] accessToken: {}, refreshToken: {}", accessToken, refreshToken);
